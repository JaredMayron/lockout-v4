...
$params = [
  'values' => ['source_contact_id' => $_REQUEST['id'], 'activity_type_id' => $_ENV['CIVICRM_RFID_ACTVITY'], 'status_id' => 2, 'subject' => $_REQUEST['name'], 'activity_date_time' => date('Y-m-d H:i:s'), 'assignee_contact_id' => [$_REQUEST['id']]],
];
